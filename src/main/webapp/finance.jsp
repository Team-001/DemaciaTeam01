...
<form action="">
    <table class="table1">
        ...
        <tr>
            <td class="trTitle" colspan="4">
                <div sid="panel5" class="mini-panel" title="⬇️操作信息" style="width:100%;height:170px;"
                     allowResize="true" collapseOnTitleClick="true">
                    <table class="table1">
                        <tr>
                            <td style="width:120px;height: 60px; background-color:#e9f6fe">要求</td>
                            <td colspan="3"><input style="width: 100%;height: 60px; overflow: scroll" class="mini-textarea"/></td>
                        </tr>
                        <tr>
                            <td style="width:120px;height: 60px; background-color:#e9f6fe">建议</td>
                            <td colspan="3"><input style="width: 100%;height: 60px; overflow: scroll" class="mini-textarea"/></td>
                        </tr>
                    </table>
                </div>
